...
function startStream() {
    ...
    remotestream.onaddstream = function (e) {
        try {
            ...
            vid2.srcObject = e.stream.clone();
            vid2.onloadedmetadata = function (e) {
                vid2.play();
            };
              var depthStream = e.stream.clone();
            depthStream.removeTrack(depthStream.getVideoTracks()[0]);
            var depth = document.getElementById('depth');
            depth.srcObject = depthStream;
            depth.onloadedmetadata = function (e) {
                depth.play();
            };
            console.log("Got " + e.stream.getVideoTracks().length + " tracks from other device");
